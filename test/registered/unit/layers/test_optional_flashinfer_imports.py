"""Regression tests for importing the CUDA server without FlashInfer."""
...
class TestOptionalFlashinferImports(CustomTestCase):
    def test_server_import_succeeds_without_flashinfer(self):
